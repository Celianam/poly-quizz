...
<% String pseudoJoueurCourant = ((Joueur)session.getAttribute("joueur")).getPseudo(); %>
<title>Bienvenu(e) <%=pseudoJoueurCourant%></title>
									...
									<%
										...
										for (Joueur j : joueurs) {
											...
											if (!j.equals(joueurCourant)) {
												...
												List<Partie> parties = PartieRepository.alreadyMet(
														joueurCourant, j);
												if (!parties.isEmpty()) {
													iconRencontre = "ok";
												} else {
										...
										<td><center>
												<div class="btn-group">
													<input class="btn btn-primary" type="submit"
														name="<%=j.getPseudo()%>" value="Inviter" />
												</div>
											</center></td>
										<td><center>
